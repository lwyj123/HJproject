...
layui.define(['layer', 'laytpl', 'upload'], function(exports) {
    ...
    var setSkin = function(layero) {
        ...
        layero.css({
            'background-image': skin ? 'url(' + skin + ')' : function() {
                return cache.base.initSkin ? 'url(' + (layui.cache.dir + 'css/modules/layim/skin/' + cache.base.initSkin) + ')' : 'none';
            }()
        });
    };
    ...
    'modules/layim/layim.css?v=3.01Pro', 'skinlayimcss'
);
